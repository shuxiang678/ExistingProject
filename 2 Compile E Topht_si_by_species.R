...
tree_list1 <- fread("H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/tree_list1.csv")
...
fwrite(pgyi_compiled, "H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/i_pgyi_compiled.csv")

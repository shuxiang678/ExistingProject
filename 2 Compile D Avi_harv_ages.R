...
photo.avi <- fread("H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/i_photo_avi.csv")
plot <- fread("H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/i_plot.csv")
plot_mmt <- fread("H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/i_plot_measurement.csv")
treatment <- fread("H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/i_treatment.csv")
disturbance <- fread("H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/i_disturbance.csv")
plot_level1 <- fread("H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/i_plot_level1.csv")
...
fwrite(plot_level2, "H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/i_plot_level2.csv")

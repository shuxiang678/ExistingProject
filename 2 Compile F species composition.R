...
pgyi_compiled <- fread("H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/i_pgyi_compiled.csv")
...
fwrite(pgyi.compiledstratified, "H:/Shared drives/Model Comparison/Compilation_Code_R/PGYI Compiled/i_pgyi.compiledstratified.csv")
